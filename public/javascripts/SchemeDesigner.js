...
(function() {
  var AppControl, AreaBuffer, AreaMap, DrawArea, EventsHanlerInitializer, SchemeData, SchemeElement, SchemeLine,
  ...
  AppControl = (function() {
    ...
    AppControl.prototype.InitDrawingArea = function() {
      ...
      return this.areaMap = new AreaMap(this.appConfig.canvasWidth, this.appConfig.canvasHeight, this.appConfig.gridStep);
    };
    ...
    AppControl.prototype.InitEventHandlers = function() {
      return this.EventsHanlerInitializer = new EventsHanlerInitializer(this);
    };
  ...
  AreaMap = (function() {
    function AreaMap(width, height, step) {
      ...
      this.map = new Array(Math.round(this.width / this.step) + 1);
      for (i = _i = 0, _ref = this.map.length; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        this.map[i] = new Array(Math.round(height / this.step) + 1);
      }
    }
    ...
    AreaMap.prototype.GetRectMapRange = function(x, y, w, h) {
      return {
        fromJ: Math.round(y / this.step),
        toJ: Math.round((y + h) / this.step),
        fromI: Math.round(x / this.step),
        toI: Math.round((x + w) / this.step)
      };
    };
  ...
  DrawArea = (function() {
    ...
    DrawArea.prototype.GetCanvasCoords = function(mouseX, mouseY) {
      ...
      return {
        canvasX: c.canvasX,
        canvasY: c.canvasY,
        mapCellX: Math.round(c.canvasX / this.appConfig.gridStep),
        mapCellY: Math.round(c.canvasY / this.appConfig.gridStep)
      };
    };
  ...
  EventsHanlerInitializer = (function() {
    function EventsHanlerInitializer(app) {
      ...
      this.onCanVerticalResize = __bind(this.onCanVerticalResize, this);
      this.onCanHorizontalResize = __bind(this.onCanHorizontalResize, this);
      ...
      this.InitEventHandlers();
      this.areaEvents = {
        onCanHorizontalResize: false,
        onCanVerticalResize: false,
        onLeftResize: false,
        onTopResize: false,
        onRightResize: false,
    ...
    EventsHanlerInitializer.prototype.CheckOnLeftResize = function(x) {
      this.areaEvents.onCanHorizontalResize = this.elem.obj.IsLeftResize(x);
      return this.areaEvents.onLeftResize = this.areaEvents.onLeftResize || (this.areaEvents.onCanHorizontalResize && this.areaEvents.onMouseDown);
    };

    EventsHanlerInitializer.prototype.CheckOnRightResize = function(x) {
      this.areaEvents.onCanHorizontalResize = this.elem.obj.IsRightResize(x);
      return this.areaEvents.onRightResize = this.areaEvents.onRightResize || (this.areaEvents.onCanHorizontalResize && this.areaEvents.onMouseDown);
    };

    EventsHanlerInitializer.prototype.CheckOnTopResize = function(y) {
      this.areaEvents.onCanVerticalResize = this.elem.obj.IsTopResize(y);
      return this.areaEvents.onTopResize = this.areaEvents.onTopResize || (this.areaEvents.onCanVerticalResize && this.areaEvents.onMouseDown);
    };

    EventsHanlerInitializer.prototype.CheckOnBottomResize = function(y) {
      this.areaEvents.onCanVerticalResize = this.elem.obj.IsBottomResize(y);
      return this.areaEvents.onBottomResize = this.areaEvents.onBottomResize || (this.areaEvents.onCanVerticalResize && this.areaEvents.onMouseDown);
    };

    EventsHanlerInitializer.prototype.CheckOnResize = function() {
      if (this.areaEvents.onLeftResize || this.areaEvents.onTopResize || this.areaEvents.onBottomResize || this.areaEvents.onRightResize) {
        return this.areaEvents.onResize = true;
      } else {
        return this.areaEvents.onResize = false;
      }
    };

    EventsHanlerInitializer.prototype.CheckOnMoveElement = function() {
    ...
    EventsHanlerInitializer.prototype.CheckResizeEvents = function(e) {
      var c;
    ...
    EventsHanlerInitializer.prototype.GetOnMouseHoverElement = function(e) {
      var c, idHover;
      c = this.app.drawingArea.GetCanvasCoords(e.pageX, e.pageY);
    ...
    EventsHanlerInitializer.prototype.MakeBackLight = function(element) {
      element.obj.isMouseHover = true;
      this.app.UpdateArea();
      return element.obj.isMouseHover = false;
    };

    EventsHanlerInitializer.prototype.SetCursorMove = function() {
      return $('#' + this.app.appConfig.canvasId)[0].style.cursor = 'move';
    };

    EventsHanlerInitializer.prototype.onMouseHoverOnElement = function(e) {
      this.SetCursorMove();
    ...
    EventsHanlerInitializer.prototype.onLeftResize = function(e) {
      var c;
      c = this.app.drawingArea.GetCanvasCoords(e.pageX, e.pageY);
      return this.elem.obj.ResizeLeft(c.canvasX);
    };

    EventsHanlerInitializer.prototype.onRightResize = function(e) {
      var c;
      c = this.app.drawingArea.GetCanvasCoords(e.pageX, e.pageY);
      return this.elem.obj.ResizeRight(c.canvasX);
    };

    EventsHanlerInitializer.prototype.onTopResize = function(e) {
      var c;
      c = this.app.drawingArea.GetCanvasCoords(e.pageX, e.pageY);
      return this.elem.obj.ResizeTop(c.canvasY);
    };

    EventsHanlerInitializer.prototype.onBottomResize = function(e) {
      var c;
      c = this.app.drawingArea.GetCanvasCoords(e.pageX, e.pageY);
      return this.elem.obj.ResizeBottom(c.canvasY);
    };

    EventsHanlerInitializer.prototype.onResize = function() {};

    EventsHanlerInitializer.prototype.onMoveElement = function(e) {
      var c;
    ...
    EventsHanlerInitializer.prototype.onMouseUp = function() {};

    EventsHanlerInitializer.prototype.onCanHorizontalResize = function(e) {
      return $('#' + this.app.appConfig.canvasId)[0].style.cursor = 'col-resize';
    };

    EventsHanlerInitializer.prototype.onCanVerticalResize = function(e) {
      return $('#' + this.app.appConfig.canvasId)[0].style.cursor = 'row-resize';
    };

    EventsHanlerInitializer.prototype.onMouseHoverOnEmptySpace = function(e) {
    ...
    EventsHanlerInitializer.prototype.onMouseDown = function(e) {
      return this.app.UpdateArea();
    };

    EventsHanlerInitializer.prototype.InitEventHandlers = function() {
    ...
    EventsHanlerInitializer.prototype.ExecuteEventHandlers = function(e, ui) {
  ...
  SchemeElement = (function() {
    ...
    SchemeElement.prototype.PlaceToMap = function() {
      ...
      startI = Math.round(this.x / this.areaMap.step);
      startJ = Math.round(this.y / this.areaMap.step);
      toI = Math.round(this.width / this.areaMap.step) + startI;
      toJ = Math.round(this.height / this.areaMap.step) + startJ;
      _results = [];
      for (i = _i = startI; startI <= toI ? _i <= toI : _i >= toI; i = startI <= toI ? ++_i : --_i) {
        _results.push((function() {
          var _j, _results1;
    ...
    SchemeElement.prototype.ValidateCoords = function(x, y) {
      if (this.areaMap.ValidateMapIndexes(y, x) && this.areaMap.GetCellByCoords(y, x) === void 0) {
        return true;
      } else {
        return false;
      }
    ...
    SchemeElement.prototype.ResizeBottom = function(newY) {
      ...
      if (!(this.ValidateCoords(0, newY) && this.ValidateNewSize(newH) && this.ValidateRange(r))) {
        return false;
      }
      this.RemoveFromMap();
      this.height = newH;
    ...
    SchemeElement.prototype.ResizeLeft = function(newX) {
      ...
      if (!(this.ValidateCoords(newX, 0) && this.ValidateNewSize(newW) && this.ValidateRange(r))) {
        return false;
      }
      this.RemoveFromMap();
      this.width = newW;
    ...
    SchemeElement.prototype.Move = function(newX, newY) {
      ...
      if (!(this.ValidateCoords(newX, 0) && this.ValidateRange(r))) {
        return false;
      }
      this.RemoveFromMap();
      this.x = newX;
